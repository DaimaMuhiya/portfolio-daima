...
const skillIcons = [
  ...
  { name: "Appache", icon: "/icons/skills/Apache.svg" },
  ...
  { name: "Apple", icon: "/icons/skills/Apple.svg" },
  { name: "Android", icon: "/icons/skills/Android.svg" },
  { name: "Figma", icon: "/icons/skills/Figma.svg" },
  { name: "Canva", icon: "/icons/skills/Canva.svg" },
  { name: "Jira", icon: "/icons/skills/Jira.svg" },
